# Generated by Django 4.2.7 on 2024-02-19 19:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('dog', 'Собака'), ('cat', 'Кошка'), ('horse', 'Лошадь'), ('goat', 'Коза'), ('sheep', 'Овца'), ('hen', 'Курица'), ('pig', 'Свин'), ('fish', 'Рыба')], max_length=60, verbose_name='Тип животного')),
                ('icon', models.ImageField(upload_to='media/icons/', verbose_name='Иконка')),
            ],
            options={
                'verbose_name': 'Иконка животного',
                'verbose_name_plural': 'Иконкы животного',
            },
        ),
        migrations.CreateModel(
            name='Order',
